...
* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,358 | 🐛 727 | 🌐 C++ | 📅 2026-09-05 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 670 | 🐛 457 | 🌐 Python | 📅 2026-09-05 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,223 | 🐛 7 | 🌐 C++ | 📅 2026-09-05 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,790 | 🐛 105 | 🌐 C++ | 📅 2026-09-05 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [weymouth/WaterLily.jl](https://github.com/weymouth/WaterLily.jl) ⭐ 832 | 🐛 27 | 🌐 Julia | 📅 2026-09-01 -  Fast and simple fluid simulator in Julia. ![julia](logo/julia.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 417 | 🐛 125 | 🌐 Fortran | 📅 2026-09-05 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [camUrban/PteraSoftware](https://github.com/camUrban/PteraSoftware) ⭐ 266 | 🐛 39 | 🌐 Python | 📅 2026-09-05 - A fast, easy-to-use, and open-source software package for analyzing flapping-wing flight. ![Python](logo/Python.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 444 | 🐛 178 | 🌐 C++ | 📅 2026-09-05 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,747 | 🐛 216 | 🌐 Fortran | 📅 2026-09-05 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)
...
* [uDALES/u-dales](https://github.com/uDALES/u-dales) ⭐ 84 | 🐛 49 | 🌐 Jupyter Notebook | 📅 2026-09-05 - uDALES: large-eddy-simulation software for urban flow, dispersion and microclimate modelling. ![FORTRAN](logo/FORTRAN.svg)

### Shallow Water / Ocean Dynamics

* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,412 | 🐛 355 | 🌐 Julia | 📅 2026-09-05 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,409 | 🐛 316 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,222 | 🐛 157 | 🌐 Julia | 📅 2026-09-05 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [PavelDoGreat/WebGL-Fluid-Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,610 | 🐛 75 | 🌐 JavaScript | 📅 2024-11-12 - Play with fluids in your browser (works even on mobile). ![JavaScript](logo/JavaScript.svg)
...
* [cornellius-gp/gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,907 | 🐛 419 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. ![Python](logo/Python.svg)
...
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 242 | 🐛 0 | 🌐 Fortran | 📅 2026-09-05 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 242 | 🐛 0 | 🌐 Fortran | 📅 2026-09-05
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,663 | 🐛 2,335 | 🌐 Python | 📅 2026-09-05 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 93,179 | 🐛 494 | 🌐 Python | 📅 2026-09-01 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,156 | 🐛 1,469 | 🌐 Python | 📅 2026-09-05 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
* [mwaskom/seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,012 | 🐛 231 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization in Python. ![Python](logo/Python.svg)
...
* [scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,580 | 🐛 947 | 🌐 Python | 📅 2026-09-04 - Image processing in Python. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 20,021 | 🐛 0 | 🌐 C++ | 📅 2026-09-05 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,795 | 🐛 601 | 🌐 Python | 📅 2026-09-05 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
...
* [iterative/dvc](https://github.com/iterative/dvc) ⭐ 15,861 | 🐛 203 | 🌐 Python | 📅 2026-08-31 - Data Version Control, Git for Data & Models, ML Experiments Management. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,820 | 🐛 158 | 📅 2026-09-03 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
