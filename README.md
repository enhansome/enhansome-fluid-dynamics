...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,050 | 🐛 686 | 🌐 C++ | 📅 2026-09-14 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,836 | 🐛 194 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [p-costa/CaNS](https://github.com/p-costa/CaNS) ⭐ 277 | 🐛 0 | 🌐 Fortran | 📅 2026-09-03 - A code for fast, massively-parallel direct numerical simulations (DNS) of canonical flows. ![FORTRAN](logo/FORTRAN.svg)

### Finite Element Methods (FEM)

* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,365 | 🐛 736 | 🌐 C++ | 📅 2026-09-18 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,204 | 🐛 129 | 🌐 C++ | 📅 2026-09-18 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 674 | 🐛 454 | 🌐 Python | 📅 2026-09-18 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
* [kinnala/scikit-fem](https://github.com/kinnala/scikit-fem) ⭐ 660 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - Simple finite element assemblers. ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,240 | 🐛 7 | 🌐 C++ | 📅 2026-09-18 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,795 | 🐛 98 | 🌐 C++ | 📅 2026-09-18 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [weymouth/WaterLily.jl](https://github.com/weymouth/WaterLily.jl) ⭐ 837 | 🐛 28 | 🌐 Julia | 📅 2026-09-15 -  Fast and simple fluid simulator in Julia. ![julia](logo/julia.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 421 | 🐛 149 | 🌐 Fortran | 📅 2026-09-18 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [code-saturne/code\_saturne](https://github.com/code-saturne/code_saturne) ⭐ 307 | 🐛 30 | 🌐 C++ | 📅 2026-09-18 - code\_saturne public mirror. ![C++](logo/cpp.svg) ![FORTRAN](logo/FORTRAN.svg) ![Python](logo/Python.svg)
...
* [DelNov/T-Flows](https://github.com/DelNov/T-Flows) ⭐ 6 | 🐛 0 | 🌐 Fortran | 📅 2026-09-18 - T-Flows (stands for Turbulent Flows) is a Computational Fluid Dynamics (CFD) program, originally developed at Delft University of Technology, the Netherlands. ![FORTRAN](logo/FORTRAN.svg)
...
* [byuflowlab/FLOWUnsteady](https://github.com/byuflowlab/FLOWUnsteady) ⭐ 389 | 🐛 45 | 🌐 Julia | 📅 2026-09-16 - Mixed-fidelity unsteady aerodynamics and aeroacoustics. ![julia](logo/julia.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 446 | 🐛 198 | 🌐 C++ | 📅 2026-09-18 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,763 | 🐛 216 | 🌐 Fortran | 📅 2026-09-09 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)

### Building Energy and Urban Environments

* [NREL/EnergyPlus](https://github.com/NREL/EnergyPlus) ⭐ 1,570 | 🐛 856 | 🌐 C++ | 📅 2026-09-18 - EnergyPlus™ is a whole building energy simulation program that engineers, architects, and researchers use to model both energy consumption and water use in buildings. ![C++](logo/cpp.svg)
...
* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,413 | 🐛 376 | 🌐 Julia | 📅 2026-09-18 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
...
* [peterdsharpe/AeroSandbox](https://github.com/peterdsharpe/AeroSandbox) ⭐ 1,338 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Aircraft design optimization made fast through modern automatic differentiation. ![Python](logo/Python.svg)
...
* [precice/precice](https://github.com/precice/precice) ⭐ 973 | 🐛 242 | 🌐 C++ | 📅 2026-09-17 - A coupling library for partitioned multi-physics simulations, including, but not restricted to fluid-structure interaction and conjugate heat transfer simulations. ![C++](logo/cpp.svg)

### Chemical Kinetics

* [Cantera/cantera](https://github.com/Cantera/cantera) ⭐ 854 | 🐛 53 | 🌐 C++ | 📅 2026-09-15 - Chemical kinetics, thermodynamics, and transport tool suite. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,373 | 🐛 924 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [PavelDoGreat/WebGL-Fluid-Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,646 | 🐛 74 | 🌐 JavaScript | 📅 2024-11-12 - Play with fluids in your browser (works even on mobile). ![JavaScript](logo/JavaScript.svg)
...
* [cornellius-gp/gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,913 | 🐛 422 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. ![Python](logo/Python.svg)
* [PyFR/PyFR](https://github.com/PyFR/PyFR) ⭐ 576 | 🐛 12 | 🌐 Python | 📅 2026-09-18 - Framework for solving advection-diffusion type problems on streaming architectures using the Flux Reconstruction approach of Huynh. ![Python](logo/Python.svg)
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-18 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-18
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,770 | 🐛 2,281 | 🌐 Python | 📅 2026-09-18 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 94,046 | 🐛 500 | 🌐 Python | 📅 2026-09-09 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,236 | 🐛 1,491 | 🌐 Python | 📅 2026-09-18 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
* [mwaskom/seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,025 | 🐛 235 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization in Python. ![Python](logo/Python.svg)
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,241 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
* [scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,593 | 🐛 955 | 🌐 Python | 📅 2026-09-16 - Image processing in Python. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 20,410 | 🐛 0 | 🌐 C++ | 📅 2026-09-18 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,817 | 🐛 552 | 🌐 Python | 📅 2026-09-17 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
...
* [iterative/dvc](https://github.com/iterative/dvc) ⭐ 15,878 | 🐛 212 | 🌐 Python | 📅 2026-09-14 - Data Version Control, Git for Data & Models, ML Experiments Management. ![Python](logo/Python.svg)
* [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 8,020 | 🐛 1,456 | 🌐 Python | 📅 2026-09-18 - Sphinx is a tool that makes it easy to create intelligent and beautiful documentation for Python projects. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,026 | 🐛 159 | 📅 2026-09-18 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
