...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,028 | 🐛 677 | 🌐 C++ | 📅 2026-08-27 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,808 | 🐛 194 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [p-costa/CaNS](https://github.com/p-costa/CaNS) ⭐ 275 | 🐛 1 | 🌐 Fortran | 📅 2026-08-03 - A code for fast, massively-parallel direct numerical simulations (DNS) of canonical flows. ![FORTRAN](logo/FORTRAN.svg)

### Finite Element Methods (FEM)

* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,355 | 🐛 733 | 🌐 C++ | 📅 2026-08-30 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,189 | 🐛 127 | 🌐 C++ | 📅 2026-08-30 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 670 | 🐛 457 | 🌐 Python | 📅 2026-08-30 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
* [kinnala/scikit-fem](https://github.com/kinnala/scikit-fem) ⭐ 651 | 🐛 11 | 🌐 Python | 📅 2026-08-19 - Simple finite element assemblers. ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,216 | 🐛 7 | 🌐 C++ | 📅 2026-08-27 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,787 | 🐛 104 | 🌐 C++ | 📅 2026-08-30 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 414 | 🐛 124 | 🌐 Fortran | 📅 2026-08-30 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [camUrban/PteraSoftware](https://github.com/camUrban/PteraSoftware) ⭐ 265 | 🐛 45 | 🌐 Python | 📅 2026-08-30 - A fast, easy-to-use, and open-source software package for analyzing flapping-wing flight. ![Python](logo/Python.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 444 | 🐛 178 | 🌐 C++ | 📅 2026-08-30 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,746 | 🐛 226 | 🌐 Fortran | 📅 2026-07-27 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)
...
* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,412 | 🐛 350 | 🌐 Julia | 📅 2026-08-30 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
* [team-ocean/veros](https://github.com/team-ocean/veros) ⭐ 399 | 🐛 28 | 🌐 Python | 📅 2026-08-30 - The versatile ocean simulator, in pure Python, powered by JAX. ![Python](logo/Python.svg)
...
* [peterdsharpe/AeroSandbox](https://github.com/peterdsharpe/AeroSandbox) ⭐ 1,320 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-07-05 - Aircraft design optimization made fast through modern automatic differentiation. ![Python](logo/Python.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,347 | 🐛 926 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,394 | 🐛 316 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,220 | 🐛 145 | 🌐 Julia | 📅 2026-08-30 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 240 | 🐛 0 | 🌐 Fortran | 📅 2026-08-30 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 240 | 🐛 0 | 🌐 Fortran | 📅 2026-08-30
...
* [ronshnapp/MyPTV](https://github.com/ronshnapp/myptv) ⭐ 71 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - Python based 3D-PTV - open source pure Python three-dimensional particle tracking velocimetry. ![Python](logo/Python.svg)
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,634 | 🐛 2,340 | 🌐 Python | 📅 2026-08-30 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 92,262 | 🐛 490 | 🌐 Python | 📅 2026-08-18 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,127 | 🐛 1,473 | 🌐 Python | 📅 2026-08-30 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
...
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,156 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
* [scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,579 | 🐛 951 | 🌐 Python | 📅 2026-08-26 - Image processing in Python. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 19,911 | 🐛 0 | 🌐 C++ | 📅 2026-08-30 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,789 | 🐛 589 | 🌐 Python | 📅 2026-08-30 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
...
* [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 7,997 | 🐛 1,426 | 🌐 Python | 📅 2026-08-23 - Sphinx is a tool that makes it easy to create intelligent and beautiful documentation for Python projects. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,730 | 🐛 159 | 📅 2026-08-30 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
