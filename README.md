...
* [barbagroup/CFDPython](https://github.com/barbagroup/CFDPython) ⭐ 4,166 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19 - A sequence of Jupyter notebooks featuring the "12 Steps to Navier-Stokes". ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/barbagroup/CFDPython/search?l=jupyter-notebook) ⭐ 4,166 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19
...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,055 | 🐛 692 | 🌐 C++ | 📅 2026-09-21 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,844 | 🐛 195 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [p-costa/CaNS](https://github.com/p-costa/CaNS) ⭐ 278 | 🐛 0 | 🌐 Fortran | 📅 2026-09-21 - A code for fast, massively-parallel direct numerical simulations (DNS) of canonical flows. ![FORTRAN](logo/FORTRAN.svg)

### Finite Element Methods (FEM)

* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,366 | 🐛 725 | 🌐 C++ | 📅 2026-09-24 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,206 | 🐛 127 | 🌐 C++ | 📅 2026-09-24 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 676 | 🐛 463 | 🌐 Python | 📅 2026-09-24 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,245 | 🐛 7 | 🌐 C++ | 📅 2026-09-23 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,803 | 🐛 86 | 🌐 C++ | 📅 2026-09-24 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 423 | 🐛 150 | 🌐 Fortran | 📅 2026-09-23 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [code-saturne/code\_saturne](https://github.com/code-saturne/code_saturne) ⭐ 311 | 🐛 30 | 🌐 C++ | 📅 2026-09-24 - code\_saturne public mirror. ![C++](logo/cpp.svg) ![FORTRAN](logo/FORTRAN.svg) ![Python](logo/Python.svg)
...
* [camUrban/PteraSoftware](https://github.com/camUrban/PteraSoftware) ⭐ 268 | 🐛 34 | 🌐 Python | 📅 2026-09-24 - A fast, easy-to-use, and open-source software package for analyzing flapping-wing flight. ![Python](logo/Python.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 446 | 🐛 203 | 🌐 C++ | 📅 2026-09-24 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,768 | 🐛 213 | 🌐 Fortran | 📅 2026-09-24 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)

### Building Energy and Urban Environments

* [NREL/EnergyPlus](https://github.com/NREL/EnergyPlus) ⭐ 1,575 | 🐛 855 | 🌐 C++ | 📅 2026-09-24 - EnergyPlus™ is a whole building energy simulation program that engineers, architects, and researchers use to model both energy consumption and water use in buildings. ![C++](logo/cpp.svg)
...
* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,416 | 🐛 370 | 🌐 Julia | 📅 2026-09-24 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
...
* [precice/precice](https://github.com/precice/precice) ⭐ 975 | 🐛 239 | 🌐 C++ | 📅 2026-09-23 - A coupling library for partitioned multi-physics simulations, including, but not restricted to fluid-structure interaction and conjugate heat transfer simulations. ![C++](logo/cpp.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,380 | 🐛 924 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,438 | 🐛 318 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,229 | 🐛 168 | 🌐 Julia | 📅 2026-09-23 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [PavelDoGreat/WebGL-Fluid-Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,658 | 🐛 74 | 🌐 JavaScript | 📅 2024-11-12 - Play with fluids in your browser (works even on mobile). ![JavaScript](logo/JavaScript.svg)
...
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-24 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-24
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,824 | 🐛 2,265 | 🌐 Python | 📅 2026-09-24 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 94,223 | 🐛 501 | 🌐 Python | 📅 2026-09-09 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,261 | 🐛 1,488 | 🌐 Python | 📅 2026-09-24 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
...
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,251 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 20,515 | 🐛 0 | 🌐 C++ | 📅 2026-09-24 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,824 | 🐛 525 | 🌐 Python | 📅 2026-09-24 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
...
* [su2code/TestCases](https://github.com/su2code/TestCases) ⭐ 72 | 🐛 8 | 🌐 GLSL | 📅 2026-09-24 - An extensive collection of common test cases for SU2. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 8,029 | 🐛 1,457 | 🌐 Python | 📅 2026-09-21 - Sphinx is a tool that makes it easy to create intelligent and beautiful documentation for Python projects. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,147 | 🐛 161 | 📅 2026-09-23 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
