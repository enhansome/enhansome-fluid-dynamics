...
* [barbagroup/CFDPython](https://github.com/barbagroup/CFDPython) ⭐ 4,128 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19 - A sequence of Jupyter notebooks featuring the "12 Steps to Navier-Stokes". ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/barbagroup/CFDPython/search?l=jupyter-notebook) ⭐ 4,128 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19
...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,034 | 🐛 685 | 🌐 C++ | 📅 2026-09-04 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,817 | 🐛 194 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,358 | 🐛 728 | 🌐 C++ | 📅 2026-09-06 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,191 | 🐛 126 | 🌐 C++ | 📅 2026-09-05 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 672 | 🐛 458 | 🌐 Python | 📅 2026-09-06 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
...
* [FluidityProject/fluidity](https://github.com/FluidityProject/fluidity) ⭐ 387 | 🐛 32 | 🌐 Fortran | 📅 2026-09-02 - An open-source computational fluid dynamics code with adaptive unstructured mesh capabilities. ![FORTRAN](logo/FORTRAN.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,225 | 🐛 7 | 🌐 C++ | 📅 2026-09-06 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,790 | 🐛 105 | 🌐 C++ | 📅 2026-09-06 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 125 | 🌐 Fortran | 📅 2026-09-06 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 444 | 🐛 181 | 🌐 C++ | 📅 2026-09-06 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [NREL/EnergyPlus](https://github.com/NREL/EnergyPlus) ⭐ 1,564 | 🐛 873 | 🌐 C++ | 📅 2026-09-04 - EnergyPlus™ is a whole building energy simulation program that engineers, architects, and researchers use to model both energy consumption and water use in buildings. ![C++](logo/cpp.svg)
...
* [uDALES/u-dales](https://github.com/uDALES/u-dales) ⭐ 84 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-09-06 - uDALES: large-eddy-simulation software for urban flow, dispersion and microclimate modelling. ![FORTRAN](logo/FORTRAN.svg)

### Shallow Water / Ocean Dynamics

* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,412 | 🐛 354 | 🌐 Julia | 📅 2026-09-06 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
...
* [mdolab/dafoam](https://github.com/mdolab/dafoam) ⭐ 348 | 🐛 15 | 🌐 C | 📅 2026-09-06 - DAFoam: Discrete Adjoint with OpenFOAM for High-fidelity Gradient-based Design Optimization. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [precice/precice](https://github.com/precice/precice) ⭐ 969 | 🐛 244 | 🌐 C++ | 📅 2026-09-01 - A coupling library for partitioned multi-physics simulations, including, but not restricted to fluid-structure interaction and conjugate heat transfer simulations. ![C++](logo/cpp.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,360 | 🐛 926 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,410 | 🐛 317 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,222 | 🐛 156 | 🌐 Julia | 📅 2026-09-06 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [PavelDoGreat/WebGL-Fluid-Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,613 | 🐛 75 | 🌐 JavaScript | 📅 2024-11-12 - Play with fluids in your browser (works even on mobile). ![JavaScript](logo/JavaScript.svg)
...
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 242 | 🐛 0 | 🌐 Fortran | 📅 2026-09-06 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 242 | 🐛 0 | 🌐 Fortran | 📅 2026-09-06
...
* [OpenPIV/openpiv-python](https://github.com/openpiv/openpiv-python) ⭐ 304 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-09-05 - OpenPIV consists in a Python and Cython modules for scripting and executing the analysis of a set of PIV image pairs. ![Python](logo/Python.svg) ![MATLAB](logo/MATLAB.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/OpenPIV/openpiv-python/search?l=jupyter-notebook) ⭐ 304 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-09-05
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,692 | 🐛 2,338 | 🌐 Python | 📅 2026-09-06 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
* [dynamicslab/pysindy](https://github.com/dynamicslab/pysindy) ⭐ 1,897 | 🐛 83 | 🌐 Python | 📅 2026-06-10 - A sparse regression package with several implementations for the Sparse Identification of Nonlinear Dynamical systems. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 93,280 | 🐛 494 | 🌐 Python | 📅 2026-09-01 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,197 | 🐛 1,469 | 🌐 Python | 📅 2026-09-06 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
* [mwaskom/seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,016 | 🐛 232 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization in Python. ![Python](logo/Python.svg)
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,203 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 20,073 | 🐛 0 | 🌐 C++ | 📅 2026-09-06 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,797 | 🐛 559 | 🌐 Python | 📅 2026-09-06 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
* [K3D-tools/K3D-jupyter](https://github.com/K3D-tools/K3D-jupyter) ⭐ 1,035 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - K3D lets you create 3D plots backed by WebGL with high-level API (surfaces, isosurfaces, voxels, mesh, cloud points, vtk objects, volume renderer, colormaps, etc). ![Python](logo/Python.svg) ![JavaScript](logo/JavaScript.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/K3D-tools/K3D-jupyter/search?l=jupyter-notebook) ⭐ 1,035 | 🐛 2 | 🌐 Python | 📅 2026-09-03
...
* [iterative/dvc](https://github.com/iterative/dvc) ⭐ 15,862 | 🐛 204 | 🌐 Python | 📅 2026-08-31 - Data Version Control, Git for Data & Models, ML Experiments Management. ![Python](logo/Python.svg)
* [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 8,003 | 🐛 1,429 | 🌐 Python | 📅 2026-08-31 - Sphinx is a tool that makes it easy to create intelligent and beautiful documentation for Python projects. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,830 | 🐛 158 | 📅 2026-09-03 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
