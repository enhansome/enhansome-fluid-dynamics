...
* [barbagroup/CFDPython](https://github.com/barbagroup/CFDPython) ⭐ 4,130 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19 - A sequence of Jupyter notebooks featuring the "12 Steps to Navier-Stokes". ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/barbagroup/CFDPython/search?l=jupyter-notebook) ⭐ 4,130 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19
...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,035 | 🐛 685 | 🌐 C++ | 📅 2026-09-07 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,819 | 🐛 194 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,358 | 🐛 731 | 🌐 C++ | 📅 2026-09-07 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,192 | 🐛 126 | 🌐 C++ | 📅 2026-09-05 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 672 | 🐛 458 | 🌐 Python | 📅 2026-09-07 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,225 | 🐛 7 | 🌐 C++ | 📅 2026-09-07 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,790 | 🐛 103 | 🌐 C++ | 📅 2026-09-07 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [weymouth/WaterLily.jl](https://github.com/weymouth/WaterLily.jl) ⭐ 832 | 🐛 27 | 🌐 Julia | 📅 2026-09-06 -  Fast and simple fluid simulator in Julia. ![julia](logo/julia.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 122 | 🌐 Fortran | 📅 2026-09-07 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [camUrban/PteraSoftware](https://github.com/camUrban/PteraSoftware) ⭐ 266 | 🐛 40 | 🌐 Python | 📅 2026-09-06 - A fast, easy-to-use, and open-source software package for analyzing flapping-wing flight. ![Python](logo/Python.svg)
* [vortexmethods/VM2D](https://github.com/vortexmethods/VM2D) ⭐ 36 | 🐛 5 | 🌐 C++ | 📅 2026-09-07 - VM2D: Open-Source Code for 2D Flow Simulation by Using Meshless Lagrangian Vortex Methods. ![C++](logo/cpp.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 444 | 🐛 181 | 🌐 C++ | 📅 2026-09-07 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,748 | 🐛 216 | 🌐 Fortran | 📅 2026-09-05 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)

### Building Energy and Urban Environments

* [NREL/EnergyPlus](https://github.com/NREL/EnergyPlus) ⭐ 1,566 | 🐛 873 | 🌐 C++ | 📅 2026-09-04 - EnergyPlus™ is a whole building energy simulation program that engineers, architects, and researchers use to model both energy consumption and water use in buildings. ![C++](logo/cpp.svg)
...
* [uDALES/u-dales](https://github.com/uDALES/u-dales) ⭐ 84 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-09-07 - uDALES: large-eddy-simulation software for urban flow, dispersion and microclimate modelling. ![FORTRAN](logo/FORTRAN.svg)

### Shallow Water / Ocean Dynamics

* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,412 | 🐛 356 | 🌐 Julia | 📅 2026-09-07 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
...
* [OceanParcels/parcels](https://github.com/OceanParcels/parcels) ⭐ 361 | 🐛 120 | 🌐 Python | 📅 2026-09-07 - Parcels (Probably A Really Computationally Efficient Lagrangian Simulator) is a set of Python classes and methods to create customisable particle tracking simulations using output from Ocean Circulation models. ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/OceanParcels/parcels/search?l=jupyter-notebook) ⭐ 361 | 🐛 120 | 🌐 Python | 📅 2026-09-07
...
* [mdolab/dafoam](https://github.com/mdolab/dafoam) ⭐ 348 | 🐛 15 | 🌐 C | 📅 2026-09-07 - DAFoam: Discrete Adjoint with OpenFOAM for High-fidelity Gradient-based Design Optimization. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [Cantera/cantera](https://github.com/Cantera/cantera) ⭐ 849 | 🐛 56 | 🌐 C++ | 📅 2026-09-03 - Chemical kinetics, thermodynamics, and transport tool suite. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,363 | 🐛 926 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,412 | 🐛 318 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,222 | 🐛 151 | 🌐 Julia | 📅 2026-09-07 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [cornellius-gp/gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,908 | 🐛 419 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. ![Python](logo/Python.svg)
* [PyFR/PyFR](https://github.com/PyFR/PyFR) ⭐ 573 | 🐛 13 | 🌐 Python | 📅 2026-09-03 - Framework for solving advection-diffusion type problems on streaming architectures using the Flux Reconstruction approach of Huynh. ![Python](logo/Python.svg)
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 243 | 🐛 0 | 🌐 Fortran | 📅 2026-09-07 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 243 | 🐛 0 | 🌐 Fortran | 📅 2026-09-07
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,701 | 🐛 2,302 | 🌐 Python | 📅 2026-09-07 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 93,404 | 🐛 494 | 🌐 Python | 📅 2026-09-01 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,202 | 🐛 1,472 | 🌐 Python | 📅 2026-09-07 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
* [mwaskom/seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,018 | 🐛 234 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization in Python. ![Python](logo/Python.svg)
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,205 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
* [scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,582 | 🐛 949 | 🌐 Python | 📅 2026-09-04 - Image processing in Python. ![Python](logo/Python.svg)
* [lukelbd/proplot](https://github.com/lukelbd/proplot) ⭐ 1,146 | 🐛 95 | 🌐 Python | 📅 2025-02-27 - :art: A succinct matplotlib wrapper for making beautiful, publication-quality graphics. ![Python](logo/Python.svg)

### 3D Visualization

* [blender/blender](https://github.com/blender/blender) ⭐ 20,127 | 🐛 0 | 🌐 C++ | 📅 2026-09-07 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,801 | 🐛 560 | 🌐 Python | 📅 2026-09-07 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
* [K3D-tools/K3D-jupyter](https://github.com/K3D-tools/K3D-jupyter) ⭐ 1,035 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - K3D lets you create 3D plots backed by WebGL with high-level API (surfaces, isosurfaces, voxels, mesh, cloud points, vtk objects, volume renderer, colormaps, etc). ![Python](logo/Python.svg) ![JavaScript](logo/JavaScript.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/K3D-tools/K3D-jupyter/search?l=jupyter-notebook) ⭐ 1,035 | 🐛 3 | 🌐 Python | 📅 2026-09-07
...
* [iterative/dvc](https://github.com/iterative/dvc) ⭐ 15,864 | 🐛 204 | 🌐 Python | 📅 2026-09-07 - Data Version Control, Git for Data & Models, ML Experiments Management. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,850 | 🐛 158 | 📅 2026-09-03 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
