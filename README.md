...
* [barbagroup/CFDPython](https://github.com/barbagroup/CFDPython) ⭐ 4,133 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19 - A sequence of Jupyter notebooks featuring the "12 Steps to Navier-Stokes". ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/barbagroup/CFDPython/search?l=jupyter-notebook) ⭐ 4,133 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-03-19
...
* [CGAL/cgal](https://github.com/CGAL/cgal) ⭐ 6,034 | 🐛 678 | 🌐 C++ | 📅 2026-09-09 - The Computational Geometry Algorithms Library (CGAL) is a C++ library that aims to provide easy access to efficient and reliable algorithms in computational geometry. ![C++](logo/cpp.svg)
* [cnr-isti-vclab/meshlab](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,822 | 🐛 194 | 🌐 C++ | 📅 2026-08-25 - The open source mesh processing system. ![C++](logo/cpp.svg)
...
* [p-costa/CaNS](https://github.com/p-costa/CaNS) ⭐ 276 | 🐛 0 | 🌐 Fortran | 📅 2026-09-03 - A code for fast, massively-parallel direct numerical simulations (DNS) of canonical flows. ![FORTRAN](logo/FORTRAN.svg)

### Finite Element Methods (FEM)

* [KratosMultiphysics/Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,359 | 🐛 728 | 🌐 C++ | 📅 2026-09-09 - Kratos Multiphysics (A.K.A Kratos) is a framework for building parallel multi-disciplinary simulation software. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [FEniCS/dolfinx](https://github.com/FEniCS/dolfinx) ⭐ 1,194 | 🐛 129 | 🌐 C++ | 📅 2026-09-09 - Next generation FEniCS problem solving environment. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [firedrakeproject/firedrake](https://github.com/firedrakeproject/firedrake) ⭐ 673 | 🐛 463 | 🌐 Python | 📅 2026-09-09 - Firedrake is an automated system for the portable solution of partial differential equations using the finite element method (FEM). ![Python](logo/Python.svg)
...
* [OpenFOAM/OpenFOAM-dev](https://github.com/OpenFOAM/OpenFOAM-dev) ⭐ 2,228 | 🐛 7 | 🌐 C++ | 📅 2026-09-09 - OpenFOAM is a free, open source computational fluid dynamics (CFD) software package released by the OpenFOAM Foundation. ![C++](logo/cpp.svg)
* [su2code/SU2](https://github.com/su2code/SU2) ⭐ 1,791 | 🐛 102 | 🌐 C++ | 📅 2026-09-09 - SU2: An Open-Source Suite for Multiphysics Simulation and Design. ![C++](logo/cpp.svg) ![Python](logo/Python.svg)
* [weymouth/WaterLily.jl](https://github.com/weymouth/WaterLily.jl) ⭐ 832 | 🐛 28 | 🌐 Julia | 📅 2026-09-08 -  Fast and simple fluid simulator in Julia. ![julia](logo/julia.svg)
...
* [MFlowCode/MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 121 | 🌐 Fortran | 📅 2026-09-08 - Exascale compressible multiphase flow solver with GPU acceleration (NVIDIA and AMD); 2025 Gordon Bell Prize Finalist. ![FORTRAN](logo/FORTRAN.svg)
...
* [camUrban/PteraSoftware](https://github.com/camUrban/PteraSoftware) ⭐ 266 | 🐛 37 | 🌐 Python | 📅 2026-09-08 - A fast, easy-to-use, and open-source software package for analyzing flapping-wing flight. ![Python](logo/Python.svg)
...
* [IBAMR/IBAMR](https://github.com/IBAMR/IBAMR) ⭐ 444 | 🐛 180 | 🌐 C++ | 📅 2026-09-09 - An adaptive and distributed-memory parallel implementation of the immersed boundary (IB) method. ![C++](logo/cpp.svg)
...
* [wrf-model/WRF](https://github.com/wrf-model/WRF) ⭐ 1,752 | 🐛 215 | 🌐 Fortran | 📅 2026-09-09 -  Weather Research and Forecasting (WRF) model is a numerical weather prediction (NWP) system designed to serve both atmospheric research and operational forecasting needs. ![FORTRAN](logo/FORTRAN.svg)

### Building Energy and Urban Environments

* [NREL/EnergyPlus](https://github.com/NREL/EnergyPlus) ⭐ 1,568 | 🐛 862 | 🌐 C++ | 📅 2026-09-09 - EnergyPlus™ is a whole building energy simulation program that engineers, architects, and researchers use to model both energy consumption and water use in buildings. ![C++](logo/cpp.svg)
...
* [uDALES/u-dales](https://github.com/uDALES/u-dales) ⭐ 84 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-09-09 - uDALES: large-eddy-simulation software for urban flow, dispersion and microclimate modelling. ![FORTRAN](logo/FORTRAN.svg)

### Shallow Water / Ocean Dynamics

* [CliMA/Oceananigans.jl](https://github.com/CliMA/Oceananigans.jl) ⭐ 1,413 | 🐛 357 | 🌐 Julia | 📅 2026-09-09 - Julia software for fast, friendly, flexible, data-driven, ocean-flavored fluid dynamics on CPUs and GPUs. ![julia](logo/julia.svg)
* [team-ocean/veros](https://github.com/team-ocean/veros) ⭐ 400 | 🐛 28 | 🌐 Python | 📅 2026-09-07 - The versatile ocean simulator, in pure Python, powered by JAX. ![Python](logo/Python.svg)
* [OceanParcels/parcels](https://github.com/OceanParcels/parcels) ⭐ 363 | 🐛 117 | 🌐 Python | 📅 2026-09-09 - Parcels (Probably A Really Computationally Efficient Lagrangian Simulator) is a set of Python classes and methods to create customisable particle tracking simulations using output from Ocean Circulation models. ![Python](logo/Python.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/OceanParcels/parcels/search?l=jupyter-notebook) ⭐ 363 | 🐛 117 | 🌐 Python | 📅 2026-09-09
...
* [peterdsharpe/AeroSandbox](https://github.com/peterdsharpe/AeroSandbox) ⭐ 1,324 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-07-05 - Aircraft design optimization made fast through modern automatic differentiation. ![Python](logo/Python.svg)
...
* [precice/precice](https://github.com/precice/precice) ⭐ 969 | 🐛 243 | 🌐 C++ | 📅 2026-09-01 - A coupling library for partitioned multi-physics simulations, including, but not restricted to fluid-structure interaction and conjugate heat transfer simulations. ![C++](logo/cpp.svg)
...
* [taichi-dev/taichi](https://github.com/taichi-dev/taichi) ⭐ 28,362 | 🐛 926 | 🌐 C++ | 📅 2026-07-06 - Parallel programming for everyone. ![Python](logo/Python.svg)
...
* [lululxvi/deepxde](https://github.com/lululxvi/deepxde) ⭐ 4,417 | 🐛 318 | 🌐 Python | 📅 2026-08-18 - Deep learning library for solving differential equations and more. ![Python](logo/Python.svg)
...
* [SciML/NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) ⭐ 1,223 | 🐛 153 | 🌐 Julia | 📅 2026-09-09 - Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation. ![julia](logo/julia.svg)
...
* [PavelDoGreat/WebGL-Fluid-Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,618 | 🐛 75 | 🌐 JavaScript | 📅 2024-11-12 - Play with fluids in your browser (works even on mobile). ![JavaScript](logo/JavaScript.svg)
...
* [cornellius-gp/gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,909 | 🐛 419 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. ![Python](logo/Python.svg)
...
* [pencil-code/pencil-code](https://github.com/pencil-code/pencil-code) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-09 - A high-order finite-difference code for compressible hydrodynamic flows with magnetic fields and particles. ![FORTRAN](logo/FORTRAN.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/pencil-code/pencil-code/search?l=jupyter-notebook) ⭐ 244 | 🐛 0 | 🌐 Fortran | 📅 2026-09-09
...
* [ronshnapp/MyPTV](https://github.com/ronshnapp/myptv) ⭐ 71 | 🐛 11 | 🌐 Python | 📅 2026-09-01 - Python based 3D-PTV - open source pure Python three-dimensional particle tracking velocimetry. ![Python](logo/Python.svg)
...
* [numpy/numpy](https://github.com/numpy/numpy) ⭐ 32,705 | 🐛 2,302 | 🌐 Python | 📅 2026-09-09 - The fundamental package for scientific computing with Python. ![Python](logo/Python.svg)
* [dynamicslab/pysindy](https://github.com/dynamicslab/pysindy) ⭐ 1,898 | 🐛 84 | 🌐 Python | 📅 2026-06-10 - A sparse regression package with several implementations for the Sparse Identification of Nonlinear Dynamical systems. ![Python](logo/Python.svg)
...
* [3b1b/manim](https://github.com/3b1b/manim) ⭐ 93,644 | 🐛 498 | 🌐 Python | 📅 2026-09-09 - Animation engine for explanatory math videos. ![Python](logo/Python.svg)
* [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,204 | 🐛 1,476 | 🌐 Python | 📅 2026-09-09 - matplotlib: plotting with Python. ![Python](logo/Python.svg)
* [mwaskom/seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,021 | 🐛 236 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization in Python. ![Python](logo/Python.svg)
* [garrettj403/SciencePlots](https://github.com/garrettj403/SciencePlots) ⭐ 9,213 | 🐛 19 | 🌐 Python | 📅 2026-06-23 - Matplotlib styles for scientific plotting. ![Python](logo/Python.svg)
* [scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,583 | 🐛 947 | 🌐 Python | 📅 2026-09-09 - Image processing in Python. ![Python](logo/Python.svg)
...
* [blender/blender](https://github.com/blender/blender) ⭐ 20,204 | 🐛 0 | 🌐 C++ | 📅 2026-09-09 - A free and open source 3D creation suite, supporting the entirety of the 3D pipeline-modeling, rigging, animation, simulation, rendering, compositing, motion tracking and video editing. ![Python](logo/Python.svg)
* [pyvista/pyvista](https://github.com/pyvista/pyvista) ⭐ 3,805 | 🐛 557 | 🌐 Python | 📅 2026-09-09 - 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK). ![Python](logo/Python.svg)
* [K3D-tools/K3D-jupyter](https://github.com/K3D-tools/K3D-jupyter) ⭐ 1,035 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - K3D lets you create 3D plots backed by WebGL with high-level API (surfaces, isosurfaces, voxels, mesh, cloud points, vtk objects, volume renderer, colormaps, etc). ![Python](logo/Python.svg) ![JavaScript](logo/JavaScript.svg) [![Jupyter](logo/Jupyter.svg)](https://github.com/K3D-tools/K3D-jupyter/search?l=jupyter-notebook) ⭐ 1,035 | 🐛 3 | 🌐 Python | 📅 2026-09-09
...
* [iterative/dvc](https://github.com/iterative/dvc) ⭐ 15,866 | 🐛 206 | 🌐 Python | 📅 2026-09-07 - Data Version Control, Git for Data & Models, ML Experiments Management. ![Python](logo/Python.svg)
* [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 8,004 | 🐛 1,430 | 🌐 Python | 📅 2026-09-07 - Sphinx is a tool that makes it easy to create intelligent and beautiful documentation for Python projects. ![Python](logo/Python.svg)
...
* [awesomedata/awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,880 | 🐛 159 | 📅 2026-09-09 -  A topic-centric list of HQ open datasets. ![Awesome](logo/awesome.svg)
